          ...
          <form>
            <div class="modal-body">
              ...
              <div class="mb-3" bis_skin_checked="1">
                <label class="small mb-1" for="xnama_perusahaan">Perusahaan <span class="fw-bold text-danger">*</span></label>
                <select name="xid_perusahaan" class="form-control select2" id="xid_perusahaan" required readonly>
                  <?php $query_perusahaan = mysqli_query($connection, "SELECT * FROM tbl_perusahaan WHERE id = {$_SESSION['id_perusahaan']}") ?>
