          ...
          <div class="container-xl px-4 mt-5">
            ...
            <div class="card card-header-actions mb-4 mt-5">
              <div class="card-header">
                ...
                <button class="btn btn-sm btn-primary toggle_modal_tambah" type="button"><i data-feather="plus-circle" class="me-2"></i>Tambah Perusahaan</button>
              </div>
              <div class="card-body">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <button class="btn btn-datatable btn-icon btn-transparent-dark me-2 toggle_swal_hapus"
                            data-id_perusahaan="<?= $perusahaan['id_perusahaan'] ?>" 
                            data-id_pengguna="<?= $perusahaan['id_pengguna'] ?>" 
    ...
    <script>
      $(document).ready(function() {
        ...
        $('.toggle_modal_tambah').on('click', function() {
          $('#ModalInputPerusahaan .modal-title').html(`<i data-feather="plus-circle" class="me-2 mt-1"></i>Tambah Perusahaan`);
          $('#ModalInputPerusahaan form').attr({action: 'perusahaan_tambah.php', method: 'post'});
          $('#ModalInputPerusahaan #xpassword').attr('required', true);
          $('#ModalInputPerusahaan #xpassword_help').html('');
        ...
        $('.toggle_modal_ubah').on('click', function() {
          ...
          $('#ModalInputPerusahaan form').attr({action: 'perusahaan_ubah.php', method: 'post'});
        ...
        $('#datatablesSimple').on('click', '.toggle_swal_hapus', function() {
          ...
          Swal.fire({
            ...
            html: `<div class="mb-1">Hapus data perusahaan:</div><strong>${nama_perusahaan}?</strong>`,
            icon: "warning",
            ...
            if (result.isConfirmed) {
              Swal.fire({
                ...
                window.location = `perusahaan_hapus.php?xid_perusahaan=${id_perusahaan}&xid_pengguna=${id_pengguna}`;
              });
            }
          });
        });
